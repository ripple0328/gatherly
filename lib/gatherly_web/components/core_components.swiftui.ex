defmodule GatherlyWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `GatherlyWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GatherlyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GatherlyWeb.Gettext, "errors", msg, opts)
    end
  end
